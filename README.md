<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/images/nfcore-tools_logo_dark.png?raw=true">
  <source media="(prefers-color-scheme: light)" srcset="docs/images/nfcore-tools_logo_light.png?raw=true">
  <img alt="Shows nf-core logo with black font in light color mode and a white font in dark color mode." src="docs/images/nfcore-tools_logo_light.png?raw=true">
</picture>
